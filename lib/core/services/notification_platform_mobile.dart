...
/// Mobile implementation: local scheduled reminders via the
/// flutter_local_notifications plugin (Android/iOS).
class NotificationServicePlatform {
  ...
  static Future<bool> enableDailyNudges() async {
    await scheduleStandardReminders();
    return true;
  }
